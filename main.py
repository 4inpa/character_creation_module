...
def attack(char_name: str, char_class: str) -> str:
    """Depend of user class return damage."""
...
def defence(char_name: str, char_class: str) -> str:
    """Depend of user class return defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Depend of user class return index of special skill."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Depend of user class return description of class.
    Then instructs users of skills.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Writes down the name and offers classes to choose from."""
    approve_choice: str = ''
    char_class: str = ''
